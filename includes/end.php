...
$message = sprintf(
    __('Site info exported successfully. Click <a href="%s" target="_blank">here</a> to download your TXT. Or click <a href="tools.php?page=accelera-export">here</a> to go back.', 'accelera-export'),
    esc_url( $url )
);
